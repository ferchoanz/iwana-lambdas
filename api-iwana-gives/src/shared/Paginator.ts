...
import { IPaginatorConfig } from './interfaces/IPaginatorConfig';
...
export class Paginator implements IPaginator {
    ...
    private readonly offsetLimit: boolean;

    // eslint-disable-next-line prettier/prettier
    constructor(
        queryBuilder: SelectQueryBuilder<any>,
        criteria: ICriteria,
        config: IPaginatorConfig = { metadata: {}, helper: null, offsetLimit: false },
    ) {
        ...
        this.offsetLimit = config.offsetLimit ?? false;
    }
    ...
    private addPagination() {
        ...
        if (exist) {
            this.queryBuilder[this.offsetLimit ? 'offset' : 'skip'](this.pagination.getOffset())[
                this.offsetLimit ? 'limit' : 'take'
